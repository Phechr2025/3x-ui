...
```
bash <(curl -Ls https://raw.githubusercontent.com/Phechr2025/3x-ui/main/install.sh)
```
...
```
VERSION=v1.7.9 && bash <(curl -Ls "https://raw.githubusercontent.com/Phechr2025/3x-ui/$VERSION/install.sh") $VERSION
```
